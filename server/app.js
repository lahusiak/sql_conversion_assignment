...
var pg = require('pg');
var connectionString = process.env.DATABASE_URL || 'postgres://localhost:5432/people';
...
app.post('/data', function(req,res){
    ...
    var addedPerson = {
        ...
        "age" : req.body.ageAdd,
        "spirit_animal" : req.body.spirit_animalAdd,
    ...
    pg.connect(connectionString, function (err, client) {
        ...
        //var query = "INSERT INTO people (name, age, spirit_animal, address) VALUES ('" + addedPerson.name + "', '" + addedPerson.location + "')";
        //console.log(query);
        //client.query(query);
